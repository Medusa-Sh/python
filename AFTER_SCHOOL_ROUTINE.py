...
routine_message = Label(window,text="Click here to check your routine",
    bg="#266483",width=32,height=3)
...
check_button = Button(window,text="Check My Routine",command=check_routine)
